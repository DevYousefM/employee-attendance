...
function exportData() {
    ...
    const filePath = path.join(os.homedir(), "Desktop", `Attendance_Report_${year}_${month + 1}.xlsx`);
    ...
    try {
        ...
        if (error.message.includes("EBUSY")) {
            alert("الملف مفتوح حاليًا أو مؤمن. الرجاء إغلاق 'Attendance_Report_2024_10.xlsx' إذا كان مفتوحًا وحاول مرة أخرى.");
        } else {
